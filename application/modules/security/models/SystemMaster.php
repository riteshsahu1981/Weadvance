...
class Security_Model_SystemMaster {
    ...
    public function setStrval3($strval3)
    {
        $this->_strval3 = (string) $strval3;
        return $this;
    }

    public function getStrval3()
    {
        return $this->_strval3;
    }     
    
    public function setBlnval1($blnval1)
    {
        $this->_blnval1 =  $blnval1;
        return $this;
    }
  ...
  /*----Data Manupulation functions ----*/
    ...
    public function setModel($row)
    {
      ...
      if (empty($row->strval3))
      $row->strval3='defaultmenuicon.jpg';
    ...
    public function getAnimalArray()
    {
        ...
        ->from('system_master', array( 'master_id'=>'master_id' , 'master_value'=>'master_value') )
        ->where("master_code='fdAnimal' AND status= '1' ");
